        ...
        )
{
         ...
         i += gridDim.x * nthds_per_cta)
    {
        ...
        else
        {
            ...
            const int bboxId = ((shareLocation ? (index % numPredsPerClass): index % (numClasses * numPredsPerClass)) + bboxOffset) * 4;
            ...
            // FIXME:  const int lankmarkId = (index % numPredsPerClass)*10;
