...
from basicsr.archs.stylegan2_ocr_arch import (ConvLayer, EqualConv2d, EqualLinear, ResBlock, ScaledLeakyReLU,
                                          StyleGAN2OCRGenerator)
from basicsr.ops.fused_act import FusedLeakyReLU
from basicsr.utils.registry import ARCH_REGISTRY


class StyleGAN2OCRGeneratorSFT(StyleGAN2OCRGenerator):
    """StyleGAN2 Generator.
    ...
    def __init__(self,
                 ...
                 narrow=1,
                 sft_half=False):
        super(StyleGAN2OCRGeneratorSFT, self).__init__(
...
class GFPGANv1OCR(nn.Module):
    ...
    def __init__(
        ...
        super(GFPGANv1OCR, self).__init__()
        ...
        self.final_linear = EqualLinear(
            channels['4'] * 4 * 4 * int(input_width/input_height), linear_out_channel, bias=True, bias_init_val=0, lr_mul=1, activation=None)

        self.stylegan_decoder = StyleGAN2OCRGeneratorSFT(
            input_width=input_width,
            input_height=input_height,
            num_style_feat=num_style_feat,
            num_mlp=num_mlp,
